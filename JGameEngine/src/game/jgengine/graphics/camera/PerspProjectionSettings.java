...
public class PerspProjectionSettings
{
	...
	public PerspProjectionSettings(float fov, Window window)
	{
		this(fov, window.getSize().x / window.getSize().y, 0.001f, 1000f);
	}
	...
	public void setAspect(Window window)
	{
		this.aspect = window.getSize().x / window.getSize().y;
	}
