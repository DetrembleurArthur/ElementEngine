...
public class SmartProgressBar extends ValuableSmartShape<ProgressBar>
{
	...
	public SmartProgressBar(float minValue, float maxValue, float currentValue, Vector2f maxSize)
	{
